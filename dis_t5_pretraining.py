...
class PT_dataset(Dataset):
    ...
    def __getitem__(self, index):
        inp = self.jb[1][index] # reverse for I2D
        out = self.jb[0][index]
...
def parse_args(parser=argparse.ArgumentParser()):
    ...
    parser.add_argument("--save_pth", default='save_model/ckpt_rev_basemskpre', type=str,)
    parser.add_argument("--lr", default=1e-4, type=float,)
    parser.add_argument("--resume", default=-1, type=int,)
    parser.add_argument("--pth_train", default='predata/data_mlm.jbl', type=str,)
